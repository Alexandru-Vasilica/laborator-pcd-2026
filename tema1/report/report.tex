...
\section{Visualized Results}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{time_vs_protocol.png}
    \caption{Time taken by protocol and block size (1 GB payload).}
    \label{fig:time_vs_protocol}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{loss_vs_blocksize.png}
    \caption{Correlation between block size and data loss for unreliable protocols (UDP and QUIC).}
    \label{fig:loss_vs_blocksize}
\end{figure}
