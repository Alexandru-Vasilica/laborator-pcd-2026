...
\author{
\IEEEauthorblockN{Cristian-George Andrei}
\IEEEauthorblockA{\textit{Faculty of Automatic Control and Computer Science}\\
\textit{University Politehnica of Bucharest}\\
Bucharest, Romania\\
crandrei@bitdefender.com}
}
...
R12 & The HPA \textit{should} scale the worker deployment to at most 6
     replicas under CPU pressure. & L &
     HPA manifest &
     \texttt{k8s/60-hpa.yaml}: maxReplicas=6 \\
\bottomrule
\end{tabular}
\end{table*}
...
different behaviour under sustained autoscaling.
...
The author thanks the VAS Laboratory instructors at University Politehnica of
Bucharest for the project specification and guidance.
